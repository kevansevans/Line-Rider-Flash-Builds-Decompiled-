...
function render()
{
    ...
    {
        _loc3 = tla._xscale;
        _loc1 = Math.min(_loc3 * 1.100000, 300);
        world._xscale = world._yscale = tla._xscale = tla._yscale = _loc1;
        world._x = tla._x = Stage.width * 0.500000 + (tla._x - Stage.width * 0.500000) * (_loc1 / _loc3);
        world._y = tla._y = Stage.height * 0.500000 + (tla._y - Stage.height * 0.500000) * (_loc1 / _loc3);
    } // end if
    ...
    switch (ver)
    {
        ...
        case "6.2":
        {
            ...
            registerInGrid = function (line)
            {
                ...
                var _loc11 = line.dx > 0 ? (_loc7.x) : (_loc1.x);
                var _loc13 = line.dx > 0 ? (_loc1.x) : (_loc7.x);
                var _loc10 = line.dy > 0 ? (_loc7.y) : (_loc1.y);
                var _loc12 = line.dy > 0 ? (_loc1.y) : (_loc7.y);
                if (line.dx == 0 && line.dy == 0 || _loc1.x == _loc7.x && _loc1.y == _loc7.y)
                {
                    register(line, _loc1.x, _loc1.y);
                    return;
                }
                ...
                while (true)
                {
                    ...
                    if (_loc1.y < 0)
                    {
                        _loc3 = line.dy > 0 ? (GRIDSIZE + _loc1.gy) : (-GRIDSIZE - _loc1.gy);
                    }
                    else
                    {
                        _loc3 = line.dy > 0 ? (GRIDSIZE - _loc1.gy) : (-(_loc1.gy + 1));
                    } // end else if
                    if (line.dx == 0)
                    {
                        _loc4 = _loc4 + _loc3;
                    ...
                    {
                        var _loc6 = _loc4 + line.dy * difX * _loc9;
                        if (Math.abs(_loc6 - _loc4) < Math.abs(_loc3))
                        {
                            _loc5 = _loc5 + difX;
                            _loc4 = _loc6;
                        }
                        else if (Math.abs(_loc6 - _loc4) == Math.abs(_loc3))
                        {
                            _loc5 = _loc5 + difX;
                            _loc4 = _loc4 + _loc3;
                        }
                        ...
                        {
                            _loc5 = _loc5 + line.dx * _loc3 * _loc8;
                            _loc4 = _loc4 + _loc3;
                        } // end else if
                    } // end else if
                    _loc1 = gridPos(_loc5, _loc4);
                    if (_loc1.x >= _loc13 && _loc1.x <= _loc11 && _loc1.y >= _loc12 && _loc1.y <= _loc10)
                    {
                        register(line, _loc1.x, _loc1.y);
                        continue;
                    } // end if
