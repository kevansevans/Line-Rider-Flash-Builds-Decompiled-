...
{
    var aso#95885, invalidateStyle, invalidateFlag, _getTextFormat, setTextFormat, setNewTextFormat, embedFonts, __text, text, _visible, textColor, setValue, getValue, stylecache, __getTextFormat, enabledColor, getTextFormat, getStyle, draw, textWidth, textHeight, align;
    function UIObjectExtensions()
    {
    } // End of the function
    static function addGeometry(tf, ui)
    {
        tf.addProperty("width", ui.aso#39621, null);
        tf.addProperty("height", ui.__get__height, null);
        tf.addProperty("left", ui.__get__left, null);
        tf.addProperty("x", ui.aso#57588, null);
        tf.addProperty("top", ui.__get__top, null);
        tf.addProperty("y", ui.aso#88925, null);
    ...
    static function Extensions()
    {
        ...
        _loc7.aso#14273 = _loc9.aso#14273;
