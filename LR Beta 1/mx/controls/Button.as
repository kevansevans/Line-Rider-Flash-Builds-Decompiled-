...
{
    var aso#45610, labelPath, initIcon, getState, enabled, phase, idNames, __width, __height, setState, invalidate, __get__labelPlacement, aso#84328, __get__label, refresh, createLabel, _iconLinkageName, removeIcons, __get__icon, aso#67332, createEmptyObject, __set__icon, __set__label, __set__labelPlacement;
    function Button()
    {
        super();
    } // End of the function
    ...
    {
        labelPath.enabled = aso#49365;
        super.setEnabled(aso#49365);
    } // End of the function
    ...
    {
        if (aso#67332 == undefined)
        {
            this.createEmptyObject("aso#67332", 100);
        } // end if
        var _loc2 = aso#67332;
        _loc2.clear();
