class mx.controls.aso#78339 extends mx.controls.listclasses.ScrollSelectList
{
    ...
    {
        aso#09676 = Math.min(__dataProvider.length - this.__get__rowCount() + roundUp, aso#09676);
        aso#09676 = Math.max(0, aso#09676);
        super.setVPosition(aso#09676);
    } // End of the function
    function setHPosition(aso#09676)
    {
        aso#09676 = Math.max(Math.min(__maxHPosition, aso#09676), 0);
        super.setHPosition(aso#09676);
        this.hScroll(aso#09676);
    } // End of the function
    ...
    function hScroll(aso#09676)
    {
        __hPosition = aso#09676;
        listContent._x = -aso#09676;
    } // End of the function
    function init(Void)
    {
        super.init();
    ...
    function createChildren(Void)
    {
        ...
        listContent.setMask(aso#67753);
        border_mc.aso#14273(0, 0);
    ...
    static var symbolOwner = mx.controls.aso#78339;
    static var symbolName = "aso#78339";
    var className = "aso#78339";
