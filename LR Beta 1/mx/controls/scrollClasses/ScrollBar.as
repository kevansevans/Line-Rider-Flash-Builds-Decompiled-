...
{
    var isScrolling, scrollTrack_mc, scrollThumb_mc, __get__scrollPosition, __get__pageScrollSize, __get__lineScrollSize, __height, tabEnabled, focusEnabled, aso#08284, setSkin, upArrow_mc, aso#37808, aso#69145, downArrow_mc, createObject, createClassObject, enabled, __get__virtualHeight, __set__scrollPosition, _height, dispatchEvent, minMode, maxMode, plusMode, minusMode, _parent, getStyle, aso#15244, _ymouse, __set__lineScrollSize, __set__pageScrollSize;
    function ScrollBar()
    {
        super();
    } // End of the function
    ...
    function set scrollPosition(aso#09676)
    {
        _scrollPosition = aso#09676;
        if (isScrolling != true)
        {
            aso#09676 = Math.min(aso#09676, aso#64969);
            aso#09676 = Math.max(aso#09676, minPos);
            var _loc3 = (aso#09676 - minPos) * (scrollTrack_mc.height - scrollThumb_mc._height) / (aso#64969 - minPos) + scrollTrack_mc.top;
            scrollThumb_mc.aso#14273(0, _loc3);
        } // end if
    ...
    function init(Void)
    {
        ...
        aso#08284._width = aso#08284._height = 0;
    } // End of the function
    function createChildren(Void)
    {
        ...
        aso#37808 = _loc2.height;
        aso#69145 = _loc2.width;
        ...
        _loc2.clickHandler = onScrollChanged;
        aso#37808 = aso#37808 + _loc2.height;
    } // End of the function
    ...
    function setScrollProperties(pSize, mnPos, mxPos, ls)
    {
        ...
        aso#64969 = Math.max(mxPos, 0);
        _scrollPosition = Math.max(minPos, _scrollPosition);
        _scrollPosition = Math.min(aso#64969, _scrollPosition);
        if (aso#64969 - minPos > 0 && enabled)
        {
            ...
            _loc4 = pageSize / (aso#64969 - minPos + pageSize) * _loc2.height;
            if (_loc4 < _loc3.minHeight)
            {
                ...
                else
                {
                    ...
                    _loc3.setSize(aso#69145, _loc3.minHeight + 0);
                } // end else if
            }
            else
            {
                _loc3.__set__visible(true);
                _loc3.setSize(aso#69145, _loc4);
            } // end else if
            _loc3.setRange(upArrow_mc.__get__height() + 0, this.__get__virtualHeight() - downArrow_mc.__get__height() - _loc3.__get__height(), minPos, aso#64969);
            _loc5 = Math.min(_loc5, aso#64969);
    ...
    function setEnabled(enabledFlag)
    {
        ...
        this.setScrollProperties(pageSize, minPos, aso#64969, largeScroll);
    } // End of the function
    function draw(Void)
    {
        if (aso#45610)
    ...
    function size(Void)
    {
        ...
        upArrow_mc.aso#14273(0, 0);
        var _loc4 = scrollTrack_mc;
        _loc4._y = _loc3;
        _loc4._height = this.__get__virtualHeight() - _loc3 - _loc2;
        downArrow_mc.aso#14273(0, this.__get__virtualHeight() - _loc2);
        this.setScrollProperties(pageSize, minPos, aso#64969, largeScroll);
    } // End of the function
    ...
    function isScrollBarKey(k)
    {
        ...
        {
            if (this.__get__scrollPosition() < aso#64969)
            {
                this.__set__scrollPosition(aso#64969);
    ...
    function startTrackScroller(Void)
    {
        ...
        _parent.aso#15244 = setInterval(_parent, "scrollInterval", this.getStyle("repeatDelay"), "Page", -1);
    } // End of the function
    function scrollInterval(inc, mode)
    {
        clearInterval(aso#15244);
        if (inc == "Page")
        {
            this.trackScroller();
        }
        ...
        aso#15244 = setInterval(this, "scrollInterval", this.getStyle("repeatInterval"), inc, mode);
    } // End of the function
    ...
    {
        clearInterval(_parent.aso#15244);
    ...
    var clipParameters = {minPos: 1, aso#64969: 1, pageSize: 1, scrollPosition: 1, lineScrollSize: 1, pageScrollSize: 1, visible: 1, enabled: 1};
