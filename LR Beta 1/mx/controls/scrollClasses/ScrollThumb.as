...
{
    var useHandCursor, ymin, ymax, datamin, datamax, _ymouse, lastY, scrollMove, _y, _parent, onMouseMove, grip_mc, gripSkin, setSkin, __get__height, aso#39621;
    ...
    {
        super.size();
        grip_mc.aso#14273((this.aso#39621() - grip_mc.width) / 2, (this.__get__height() - grip_mc.height) / 2);
    } // End of the function
