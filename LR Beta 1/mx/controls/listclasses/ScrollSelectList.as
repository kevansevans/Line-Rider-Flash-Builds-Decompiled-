class mx.controls.listclasses.ScrollSelectList extends mx.core.ScrollView
{
    ...
    function setVPosition(aso#09676)
    {
        ...
        if (aso#09676 > 0 && aso#09676 > this.getLength() - __rowCount + roundUp)
        {
            return;
        } // end if
        var _loc8 = aso#09676 - __vPosition;
        if (_loc8 == 0)
        {
            return;
        } // end if
    ...
    function dragScroll(Void)
    {
        ...
        if (_ymouse < 0)
        {
            ...
            this.dispatchEvent({type: "scroll", aso#55775: "vertical", position: __vPosition});
        }
