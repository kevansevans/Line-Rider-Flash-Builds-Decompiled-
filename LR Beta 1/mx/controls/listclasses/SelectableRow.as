...
{
    var __height, cell, owner, rowIndex, aso#00482, createObject, __width, backGround, highlightColor, highlight, createLabel, createClassObject, listOwner, tabEnabled, item, createEmptyMovieClip, drawRect, isChangedToSelected, bGTween, grandOwner;
    ...
    function setValue(itmObj, state)
    {
        ...
        {
            _loc3 = this.createObject(_loc4, "aso#00482", 20);
            _loc3._x = 2;
