class mx.controls.listclasses.DataSelector extends Object
{
    ...
    function createProp(obj, propName, setter)
    {
        ...
        obj.addProperty(propName, _loc4, _loc2);
    } // End of the function
    ...
    function sortItems(aso#82094, order)
    {
        lastSelID = __dataProvider.getItemID(lastSelected);
        __dataProvider.sortItems(aso#82094, order);
    } // End of the function
    ...
    function setSelectedIndices(aso#02845)
    {
        ...
        delete this.selected;
        for (var _loc3 = 0; _loc3 < aso#02845.length; ++_loc3)
        {
            var _loc2 = aso#02845[_loc3];
