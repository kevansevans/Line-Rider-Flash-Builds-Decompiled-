class mx.controls.ComboBox extends mx.controls.ComboBase
{
    ...
    function getDropdown()
    {
        ...
        if (!this.hasDropdown())
        {
            ...
            __dropdown = mx.managers.PopUpManager.createPopUp(this, mx.controls.aso#78339, false, _loc3, true);
    ...
    function keyDown(e)
    {
        if (e.aso#71929 && e.code == 40)
        {
            this.displayDropdown(true);
        }
        else if (e.aso#71929 && e.code == 38)
        {
            this.displayDropdown(false);
