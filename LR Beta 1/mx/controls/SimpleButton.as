...
{
    var preset, aso#08284, useHandCursor, skinName, linkLength, _loc2, _loc4, aso#84328, destroyObject, _width, __width, _height, __height, _loc3, styleName, __emphaticStyleName, enabled, invalidate, __get__toggle, __get__value, __get__selected, pressFocus, dispatchEvent, autoRepeat, getStyle, interval, releaseFocus, createLabel, invalidateStyle, __get__emphasized, __set__emphasized, __set__selected, __set__toggle, __set__value;
    ...
    function viewIcon(varName)
    {
        ...
        aso#84328._visible = false;
        aso#84328 = _loc3;
        aso#84328._visible = true;
    } // End of the function
    ...
    function refresh(Void)
    {
        ...
        aso#84328.enabled = enabled;
    } // End of the function
    function setView(offset)
    {
        if (aso#84328 == undefined)
        {
            return;
        } // end if
        var _loc2 = offset ? (btnOffset) : (0);
        aso#84328._x = (__width - aso#84328._width) / 2 + _loc2;
        aso#84328._y = (__height - aso#84328._height) / 2 + _loc2;
    } // End of the function
    ...
    function setSelected(val)
    {
        ...
        {
            this.setState(aso#45610 ? (val) : (__state));
        } // end else if
    } // End of the function
    ...
    var aso#85299 = "falseOverIcon";
    var dfi = "falseDisabledIcon";
    var dfs = "falseDisabledSkin";
    var tui = "trueUpIcon";
    var tus = "trueUpSkin";
    var tdi = "trueDownIcon";
    var aso#37387 = "trueDownSkin";
    var trs = "trueOverSkin";
    var tri = "trueOverIcon";
    var dts = "trueDisabledSkin";
    var dti = "trueDisabledIcon";
    var rolloverSkin = mx.controls.SimpleButton.prototype.frs;
    var rolloverIcon = mx.controls.SimpleButton.prototype.aso#85299;
    ...
    var aso#45610 = true;
    var idNames = ["fus", "fds", "frs", "dfs", "tus", "aso#37387", "trs", "dts", "fui", "fdi", "aso#85299", "dfi", "tui", "tdi", "tri", "dti"];
