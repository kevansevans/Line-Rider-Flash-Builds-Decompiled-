class mx.events.UIEventDispatcher extends mx.events.EventDispatcher
{
    ...
    {
        owner.dispatchEvent({type: "keyDown", code: Key.getCode(), ascii: Key.getAscii(), aso#32790: Key.isDown(16), aso#71929: Key.isDown(17)});
    } // End of the function
    function onKeyUp(Void)
    {
        owner.dispatchEvent({type: "keyUp", code: Key.getCode(), ascii: Key.getAscii(), aso#32790: Key.isDown(16), aso#71929: Key.isDown(17)});
    } // End of the function
