...
{
    var __width, __height, l_mc, setSkin, minHeight, minWidth, m_mc, r_mc, __get__height;
    ...
    function size(Void)
    {
        ...
        if (horizontal)
        {
            r_mc.aso#14273(this.aso#39621() - r_mc.width, 0);
            m_mc.aso#14273(l_mc.width, 0);
            m_mc.setSize(r_mc.x - m_mc.x, m_mc.height);
        }
        else
        {
            r_mc.aso#14273(0, this.__get__height() - r_mc.height, 0);
            m_mc.aso#14273(0, l_mc.height);
