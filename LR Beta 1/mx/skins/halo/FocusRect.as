...
{
    var aso#08284, _yscale, _xscale, clear, beginFill, drawRoundRect, endFill, _visible, _parent, removeEventListener, getDepth, addEventListener, getStyle, height, width, y, x;
    function FocusRect()
    {
        super();
    ...
    static function classConstruct()
    {
        mx.core.UIComponent.prototype.drawFocus = function (focused)
        {
            ...
            if (!focused)
            {
                ...
                this.removeEventListener("aso#14273", _loc2);
            ...
            else
            {
                ...
                this.addEventListener("aso#14273", _loc2);
