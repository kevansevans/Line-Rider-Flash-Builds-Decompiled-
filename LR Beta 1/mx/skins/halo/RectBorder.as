...
{
    var offset, borderStyleName, getStyle, __borderMetrics, className, borderColorName, backgroundColorName, shadowColorName, highlightColorName, buttonColorName, aso#39621, __get__height, clear, _color, drawRoundRect, beginFill, drawRect, endFill;
    function RectBorder()
    {
        super();
    } // End of the function
    ...
    function drawBorder(Void)
    {
        ...
        if (_loc8 != undefined)
        {
            ...
            this.drawRect(_loc9, _loc9, this.aso#39621() - _loc9, this.__get__height() - _loc9);
            this.endFill();
        } // end if
    } // End of the function
