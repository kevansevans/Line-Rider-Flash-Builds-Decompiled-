...
{
    var popUp, setSize, aso#14273, modalWindow, _parent, _name, _visible, owner;
    function PopUpManager()
    {
    } // End of the function
    static function createModalWindow(aso#80702, o, broadcastOutsideEvents)
    {
        var _loc2 = aso#80702.createChildAtDepth("Modal", mx.managers.DepthManager.kTopmost);
    ...
    static function createPopUp(aso#80702, className, modal, initobj, broadcastOutsideEvents)
    {
        ...
        var _loc5 = aso#80702._root;
        if (_loc5 == undefined)
        {
            _loc5 = _root;
        } // end if
        while (aso#80702 != _loc5)
        {
            aso#80702 = aso#80702._parent;
        } // end while
        initobj.popUp = true;
        var _loc4 = aso#80702.createClassChildAtDepth(className, broadcastOutsideEvents || modal ? (mx.managers.DepthManager.kTopmost) : (mx.managers.DepthManager.kTop), initobj);
        var _loc2 = _root;
        ...
        if (modal)
        {
            mx.managers.PopUpManager.createModalWindow(aso#80702, _loc4, broadcastOutsideEvents);
        }
        else
        {
            if (broadcastOutsideEvents)
    ...
    function resize(Void)
    {
        ...
        this.aso#14273(_loc2.x, _loc2.y);
    } // End of the function
