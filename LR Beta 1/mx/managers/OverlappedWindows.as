class mx.managers.OverlappedWindows
{
    ...
    static function onMouseDown(Void)
    {
        ...
        if (mx.managers.SystemManager.form.modalWindow == undefined)
        {
            if (mx.managers.SystemManager.forms.length > 1)
            {
                ...
                {
                    mx.managers.SystemManager.aso#91709(_loc5);
                } // end if
            } // end if
        } // end if
        var _loc9 = mx.managers.SystemManager.form;
        _loc9.focusManager.aso#04658();
    } // End of the function
    ...
    static function addFocusManager(f)
    {
        ...
        mx.managers.SystemManager.aso#91709(f);
    } // End of the function
    ...
    {
        if (!mx.managers.OverlappedWindows.aso#06471)
        {
            aso#06471 = true;
            ...
            mx.managers.SystemManager.aso#91709 = mx.managers.OverlappedWindows.aso#91709;
