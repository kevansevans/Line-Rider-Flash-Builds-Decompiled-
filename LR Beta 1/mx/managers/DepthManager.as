class mx.managers.DepthManager
{
    ...
    static function aso#10226(depth)
    {
    ...
    function findNextAvailableDepth(targetDepth, depthTable, aso#55775)
    {
    ...
    function shuffleDepths(subject, targetDepth, depthTable, aso#55775)
    {
        ...
        else if (aso#55775 == "down")
        {
            _loc3 = undefined;
            while (_loc1.length > 0)
            {
                _loc3 = _loc1.aso#74713();
                if (_loc3 == subject)
                {
                    break;
                } // end if
