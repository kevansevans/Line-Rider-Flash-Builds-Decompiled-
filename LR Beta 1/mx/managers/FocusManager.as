class mx.managers.FocusManager extends mx.core.UIComponent
{
    ...
    function relocate(Void)
    {
        ...
        this.aso#14273(_loc2.x - 1, _loc2.y - 1);
    } // End of the function
    function init(Void)
    {
        super.init();
    ...
    function aso#91709(Void)
    {
        Key.addListener(this);
        aso#83907 = _visible = true;
    ...
    function walkTree(p, index, groupName, aso#06050, lookup, firstChild)
    {
        var _loc5 = true;
        var _loc11;
        for (var _loc11 in p)
        {
            ...
            if (_loc2._parent == p && _loc2.enabled != false && _loc2._visible != false && (_loc2.tabEnabled == true || _loc2.tabEnabled != false && (_loc2.onPress != undefined || _loc2.onRelease != undefined || _loc2.onReleaseOutside != undefined || _loc2.onDragOut != undefined || _loc2.onDragOver != undefined || _loc2.onRollOver != undefined || _loc2.onRollOut != undefined || _loc2 instanceof TextField)))
            {
                ...
                if (_loc2.tabIndex != undefined)
                {
                    ...
                    if (aso#06050 && _loc2.tabIndex > index)
                    {
                    ...
                    else if (!aso#06050 && _loc2.tabIndex < index)
                    {
                ...
                {
                    this.getTabCandidateFromChildren(_loc2, index, groupName, aso#06050, _loc5 && firstChild);
                } // end if
                _loc5 = false;
                continue;
            } // end if
        ...
        if (lookup)
        {
            if (p._parent != undefined)
            {
                if (p != _parent)
                {
                    if (_prevNode == undefined && aso#06050)
                    {
                        _needPrev = true;
                    }
                    else if (_nextNode == undefined && !aso#06050)
                    {
                        _nextIsNext = false;
                    } // end else if
                    _lastTarget = _lastTarget._parent;
                    this.getTabCandidate(p._parent, index, groupName, aso#06050, true);
                } // end if
            } // end if
        } // end if
    } // End of the function
    function getTabCandidate(o, index, groupName, aso#06050, firstChild)
    {
        var _loc2;
        var _loc3 = true;
        if (o == _parent)
        ...
        this.walkTree(_loc2, index, groupName, aso#06050, _loc3, firstChild);
    } // End of the function
    function getTabCandidateFromChildren(o, index, groupName, aso#06050, firstChild)
    {
        this.walkTree(o, index, groupName, aso#06050, false, firstChild);
    } // End of the function
    ...
    function handleEvent(e)
    {
        if (e.type == "reveal")
        {
            mx.managers.SystemManager.aso#91709(form);
        }
        else
        {
    ...
    {
        if (!mx.managers.FocusManager.aso#06471)
        {
            aso#06471 = true;
