...
{
    var arrayMode, listener, initVal, endVal, aso#01453, updateFunc, endFunc, ID;
    ...
    function getCurVal(aso#22204)
    {
        if (arrayMode)
        {
            ...
            {
                _loc3[_loc2] = this.easingEquation(aso#22204, initVal[_loc2], endVal[_loc2] - initVal[_loc2], duration);
            } // end of for
            return (_loc3);
        }
        else
        {
            return (this.easingEquation(aso#22204, initVal, endVal - initVal, duration));
        } // end else if
    } // End of the function
    function endTween()
    {
