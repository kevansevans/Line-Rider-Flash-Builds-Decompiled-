class ShalAngleBreakable extends Stick
{
   ...
   function satisfyDistance()
   {
      ...
      _loc8_ = (this.dist - this.EDGendurance) / this.dist;
      if(_loc8_ > this.EDGendurance * 0.1)
      {
         this.broken = true;
         return true;
      }
      ...
      _loc9_ = _loc4_ * _loc6_ + _loc5_ * _loc7_;
      if(_loc9_ < 0)
      {
         if(_loc9_ < - this.EDGrestLengthPerp)
         {
      ...
      else if(_loc9_ > this.EDGrestLengthPerp)
      {
         this.c.x = this.b.x + _loc2_ * this.EDGrestLength + _loc6_ * this.EDGrestLengthPerp;
         this.c.y = this.b.y + _loc3_ * this.EDGrestLength + _loc7_ * this.EDGrestLengthPerp;
      }
